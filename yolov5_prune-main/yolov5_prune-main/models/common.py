...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False, data=None, fuse=True):
        # Usage:
        #   PyTorch:      weights = *.pt
...
class BiFPN_Concat2(nn.Module):
    ...
    def forward(self, x):
        ...
        # Ensure dimension is an integer for concatenation
        concat_dim = 1 if isinstance(self.d, nn.Module) else self.d
        return torch.cat(x, concat_dim)

# Fix for BiFPN_Concat3
